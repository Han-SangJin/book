...
<%@page import="rb.cmm.vo.BookImgVO"%>
...
<div class="container-fluid text-center" id="bookInfo_content" >    
				<%
						for(int i=0; i<bkImgList.size(); i++) {
							if(bkVO.getImg_id() == bkImgList.get(i).getImgId()){
				%>
				
	<div class="col-sm-7 text-left infocenter" >
	<br>
		<div>
		<span id="bkNameH3Tag" style="font-size:2.3em; font-weight:bold;" NanumBarunGothic><%=bkVO.getBk_nm() %></span>
					...
					<div class="conDiv" >	
						...
						<ul>
							<div>
								...
								<li class="Ritem"><%=bkVO.getBk_fix_price() %>&nbsp;원</li>
							</div><br><br>
							<div>
								<li class="Litem">&nbsp;&nbsp;&nbsp;할인가</li>
								<li class="Ritem" id="Ritem_font"><%=bkVO.getBk_sel_price() %>&nbsp;원</span>&nbsp;&nbsp;<span style="font-size:1.2em; color:#F42775;">(10% 할인!)</span></li><br><br>
								<input type="hidden" name="selPrice" value="<%=bkVO.getBk_sel_price() %>">
							</div><br><br>
							<div>
								<li class="Litem">&nbsp;&nbsp;&nbsp;출간일</li>
								<li class="Ritem"><%=bkVO.getBk_dt() %></li><br>
							</div><br><br>
							<div>
								<li class="Litem">&nbsp;&nbsp;&nbsp;쪽수</li>
								<li class="Ritem"><%=bkVO.getBk_page() %>쪽</li><br>
							</div><br><br>
							<div>
								<li class="Litem">&nbsp;&nbsp;&nbsp;ISBN코드</li>
								<li class="Ritem"><%=bkVO.getBk_isbn()%></li><br>
							</div><br><br>
							<div>
								<li class="Litem">&nbsp;&nbsp;&nbsp;책 소개</li>
								<li class="Ritem" id="text_size"><%=bkVO.getBk_arti()%></li><br>
							</div><br><br>
						</ul>
						<input type="hidden" name="isbn" value="<%=bkVO.getBk_isbn()%>">	<br>
