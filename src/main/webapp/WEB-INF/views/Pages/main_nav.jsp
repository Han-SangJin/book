	  ...
	  <!-- Modal content-->
		<div class="modal-content" >
			...
			<div class="modal-body">
				 <div id="login">
					<form id="loginForm" action="<%= request.getContextPath() %>/manager/Login" method="post">
						<div id="inputbox">
							<img alt="apeach" src="<%=request.getContextPath() %>/images/apeach.png" style="width:100px; height:120px; float: left;">
							<input class="input" type="text" name="mng_id" id="mngId" placeholder="아이디"><br>
							<input class="input" type="password" name="mng_pass" id="mngPass" placeholder="비밀번호">		
...
<%-- 							<img alt="apeach" src="<%=request.getContextPath() %>/images/apeach2.png" style="width:100px; height:100px; float: right; padding-bottom: 20px;"> --%>
						...
						<div id="inputResult"><%if(msg!=null){%><%=msg %><% }%></div>
					</form>
				</div>
			</div>
